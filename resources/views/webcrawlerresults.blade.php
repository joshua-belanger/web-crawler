                ...
                <div class="p-6">
                    <div class="mt-2 text-gray-600 dark:text-gray-400 text-md">
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td>{{ $totals['numPages'] }}</td>
                                    <td>{{ $totals['numImages'] }}</td>
                                    <td>{{ $totals['numInternalLinks'] }}</td>
                                    <td>{{ $totals['numExternalLinks'] }}</td>
                                    <td>{{ $totals['avgLoadTime'] }}</td>
                                    <td>{{ $totals['avgWordCount'] }}</td>
                                    <td>{{ $totals['avgTitleLength'] }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
